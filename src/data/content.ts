...
export const FAQ_SIMPLE = [
  {
    q: "Muss ich Werkzeug bereitstellen?",
    a: "Nein, gar nichts! Ich bringe mein komplettes Profi-Werkzeug, alle Akkuschrauber und Spezialdübel selbst mit."
  },
  {
    q: "Wie erfahre ich den Preis?",
    a: "Ganz einfach: Schicken Sie mir ein Foto vom Möbelstück oder dem Karton per WhatsApp – oder rufen Sie mich kurz an. Ich nenne Ihnen direkt einen festen Festpreis."
  },
  {
    q: "Was passiert mit den vielen Kartons?",
    a: "Ich verlasse jeden Raum besenrein. Die Kartonagen falte ich ordentlich und platzsparend zusammen, damit Sie keine Unordnung haben."
  },
  {
    q: "Bauen Sie auch Spieltürme im Garten auf?",
    a: "Ja, sehr gerne! Ich montiere Spieltürme und Klettergerüste (z.B. Wickey, FATMOOSE) inklusive sicherer Bodenverankerung."
  },
  {
    q: "Wie schnell bekomme ich einen Termin?",
    a: "Meistens sehr zügig – oft schon innerhalb von 24 bis 48 Stunden oder direkt passend zu Ihrem Möbel-Liefertermin."
  }
];
